...
La courbe représentant $n_s$ en fonction de son rang n'est pas un vrai diagramme rang-abondance, mais un ``pseudo-RAC'' \autocite{Izsak2012}.
...
{Courbes d'accumulation et de raréfaction, obtenues par inventaires individuels ou groupés (\foreignlanguage{english}{``\emph{samples}''}). 
