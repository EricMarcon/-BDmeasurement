...
L'indice d'équitabilité de \textcite{Mouillot2005a}, que les auteurs nomment ``indice de régularité fonctionnelle'', est inspiré de l'indice d'équitabilité de Bulla (page~\pageref{eq:Bulla}).
...
La diversité phylogénétique $\xq{\bar{D}}{q}{}{}{}(T)$ appliquée à un arbre ultramétrique est un cas particulier de $\xq{D}{q}{\matrixsym{Z}}{}{}$ pour une matrice $\matrixsym{Z}$ dont les lignes et colonnes sont la similarité des ``espèces historiques'', c'est-à-dire les couples (espèce actuelle; branche ancestrale)\autocite[][proposition A7]{Leinster2012}.
